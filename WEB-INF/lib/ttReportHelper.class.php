...
// This is needed to get the date in user date format.
      ...
      $val['grouped_by'] = strtotime($o_date->toString($user->date_format));
      unset($o_date);
    }
  }
...
// This is needed to get the date in user date format.
  ...
  $val['date'] = strtotime($o_date->toString($user->date_format));
  unset($o_date);
...
// Execute query.
  ...
  $totals['total_days'] = ttReportHelper::getWorkingDaysCount($totals['start_date'], $totals['end_date']);
