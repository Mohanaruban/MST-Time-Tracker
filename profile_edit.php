...
if ($user->isAdmin()) {
  ...
  $form->addInput(array('type'=>'combobox','name'=>'decimal_mark','class'=>'form-control','data'=>$DECIMAL_MARK_OPTIONS,'datakeys'=>array('id','name'),'value'=>$cl_decimal_mark,
  ...
  $form->addInput(array('type'=>'combobox', 'class'=>'form-control', 'name'=>'lang','class'=>'form-control','data'=>$longname_lang,'datakeys'=>array('id','name'),'value'=>$cl_lang));
  ...
  $form->addInput(array('type'=>'combobox', 'class'=>'form-control', 'name'=>'format_date','class'=>'form-control','data'=>$DATE_FORMAT_OPTIONS,'datakeys'=>array('id','name'),'value'=>$cl_custom_format_date,
  ...
  $form->addInput(array('type'=>'combobox', 'class'=>'form-control', 'name'=>'format_time','class'=>'form-control','data'=>$TIME_FORMAT_OPTIONS,'datakeys'=>array('id','name'),'value'=>$cl_custom_format_time,
  ...
  $form->addInput(array('type'=>'combobox', 'class'=>'form-control','name'=>'start_week','class'=>'form-control','data'=>$week_start_options,'datakeys'=>array('id','name'),'value'=>$cl_start_week));
  ...
  $form->addInput(array('type'=>'combobox', 'class'=>'form-control', 'name'=>'tracking_mode','data'=>$tracking_mode_options,'value'=>$cl_tracking_mode));
  ...
  $form->addInput(array('type'=>'combobox', 'class'=>'form-control', 'name'=>'record_type','data'=>$record_type_options,'value'=>$cl_record_type));
  ...
  $form->addInput(array('type'=>'combobox', 'class'=>'form-control', 'name'=>'uncompleted_indicators','data'=>$uncompleted_indicators_options,'value'=>$cl_uncompleted_indicators));
